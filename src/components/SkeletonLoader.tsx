...
export default function SkeletonLoader() {
  return (
    <>
      <div className="d-flex d-lg-none flex-column justify-content-center align-items-center gap-3 w-100">
        <MSkeleton viewBox="0 0 320 600" backgroundColor="#e9e9ff" foregroundColor="#f8f8fb">
      ...
      <div className="d-none d-lg-flex flex-column justify-content-center align-items-center gap-3 w-100">
        <MSkeleton viewBox="0 0 320 200" backgroundColor="#e9e9ff" foregroundColor="#f8f8fb">
